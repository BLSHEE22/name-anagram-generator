...
After plugging in values, we find that an anagram search based on an initial 6-letter word would take 578.2 seconds.
...
$\large S_11 = (0.1 * 0) * 2^0 = 0$\
$\large S_10 = (0.1 * 1) * 2^1 = 0.2$\
...
$\Huge S = \sum {i=0}^{n-1}S_n-i = 0.1C * 2^i$\
